...
void displayBoardv2(int board[][5]) {
	int row, column;
...
void displayBoardv3(int board[][5], int choice) {
	int row, column;
...
int main() {
	int option;
	int choice;
	printf("How would you like successful hits to be X or Y?\n");
	printf("Enter 1 for X or any key for Y: ");
...
int main() {
	int option;
	int choice;
	printf("How would you like successful hits to be X, M, 1 or Y?\n");
	printf("Enter 1 for X, 2 for H, 3 for 1 or any key for Y: ");
	option = scanf("%d", &choice);
	getchar();
